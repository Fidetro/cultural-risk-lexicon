...
当前种子数据聚焦日本侵华相关条目：战争罪行实体、相关人物、军事部队、重大事件日期、战犯审判和抗战纪念日期。它面向人工复核流程，不用于自动审查，也不替代最终内容判断。

## 能做什么

- 将词条、别名、数字写法、拼音写法和常见近似误写关联到风险实体。
- 返回简短说明、风险类别、置信度和来源链接。
- 支持 `731`、`0731`、`七三一`、`713`、`严颂`、`yansong`、`dongtiaoyingji`、`松井石根`、`0503`、`0925`、`1945-08-15` 等案例。
...
python3 scripts/query.py dongtiaoyingji
python3 scripts/query.py 1945-08-15
```
